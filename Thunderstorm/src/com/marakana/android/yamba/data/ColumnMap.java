...
public class ColumnMap {
    ...
    private static class ColumnDef {
        ...
        /**
         * @param srcCol the column to copy
         * @param src source content vals
         * @param dst target content vals
         */
